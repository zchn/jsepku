...
\setmainfont[BoldFont={SimHei},Mapping=tex-text]{SimSun}
\setsansfont[BoldFont={SimHei},Mapping=tex-text]{SimSun}
\setromanfont[BoldFont={SimHei},Mapping=tex-text]{SimSun}
...
\begin{description}
\item[文件名] rawseg
\item[用法] rawseg xxx.raw
\item[说明] 对 xxx.raw 进行切词处理，存入 xxx.raw.seg
\item[备注] *.raw.seg文件格式：\\
  \begin{lstlisting}
    DocID term1 term2 ...
    DocID term1 term2 ...
